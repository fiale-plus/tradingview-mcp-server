...
echo "📝 Next steps:"
echo ""
echo -e "  1. ${BLUE}Restart Claude Code${NC} to load the MCP server"
echo ""
echo "  2. Try the demo commands:"
echo -e "     ${BLUE}/market-regime${NC}  - Check market health"
echo -e "     ${BLUE}/run-screener${NC}   - Run stock screener"
echo ""
echo "💡 Tips:"
echo ""
